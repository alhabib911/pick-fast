        ...
        <div className='shadow-md hover:border-[#F84B2F] rounded-b-md hover:border hover:rounded-md'>
            <Link to='/'>
                ...
                <div className='px-3 bg-gray-50'>
                    ...
                    <h4 className='text-green-500 text-xs font-semibold '>{offer}% off</h4>
                ...
                <div className='flex justify-center shadow-md hover:rounded-b-lg'>
                    <Link className='bg-[#F84B2F] rounded-b-md py-2 text-white  w-full text-center text-sm font-semibold hover:text-[#F84B2F] hover:bg-gray-200' to='/'>Add to cart</Link>
                </div>
            </Link>
        </div>
    );
